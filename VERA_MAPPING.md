# VERA Compliance Mapping: Veracity Core (PoE-A2A)

> **Verifiable Enforcement for Runtime Agents Element**: 👁️ **Element 2 — Behavior ("What are you doing?")**
> **VERA Spec**: [github.com/massivescale-ai/agentic-trust-framework](https://github.com/massivescale-ai/agentic-trust-framework)

## VERA Behavior Requirements → Implementation
...
## Beyond VERA: Where PoE Exceeds the Spec

| VERA Says | Veracity Core Does |
|:---|:---|
