...
export type AnchorBackend = 'blockchain' | 'transparency-log' | 'hash-chain-anchored' | 'worm' | 'rfc3161';
export type ReceiptAssurance = 'tool-signed' | 'gateway-observed' | 'log-correlated';
...
export type AgentPurpose = 'data_analysis' | 'customer_service' | 'infrastructure_management' | 'security_monitoring' | 'content_generation' | 'financial_operations';
